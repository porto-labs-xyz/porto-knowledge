...
# London APPROVED: Compatibility with existing Porto sources

--- id: 18-compatibility-with-existing-pips title: "Compatibility with existing Porto sources" sidebarposition: 19 --- APPROVED · IMPLEMENTATION SPECIFICATION · London 0.1.0 Status APPROVED FOR LONDON 0.1.0 describes this implementation baseline. CURRENT SOURCE describes the unchanged whitepaper/PIPs, which retain their own status and scope. London does not globally amend those sources. Their historical Beta/Mainnet.

## Connected knowledge

- describes: [[London governance departures (APPROVED)|London governance departures (APPROVED)]] (EXTRACTED)

## Source content

---
id: 18-compatibility-with-existing-pips
title: "Compatibility with existing Porto sources"
sidebar_position: 19
---
